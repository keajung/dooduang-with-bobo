...
class cardCoin extends StatefulWidget {
  final position;
  const cardCoin({Key? key, required this.position}) : super(key: key);
        ...
        children: [
          ...
          Center(
            child: FlipCard(
              ...
              front: Image.asset(
                'assets/images/cards/ไพ่เหรียญ/${cardsCoin[_position].image}',
                width: 230,
                height: 400,
                fit: BoxFit.contain,
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("${cardsCoin[_position].name}",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15,color: Colors.black), textAlign: TextAlign.center),
                      ),
                      ...
                      Text('${cardsCoin[_position].meaning}'
